...
class TextProcessor:
    ...
    def replace_word(self, text, old_word, new_word):
        """
        replace_word _summary_

        _extended_summary_

        Args:
            text (_type_): _description_
            old_word (_type_): _description_
            new_word (_type_): _description_
    ...
    def count_word_occurrences(self, text, word):
        """
        count_word_occurrences _summary_
